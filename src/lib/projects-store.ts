...
let projects: Project[] = [
  {
    ...
    status: 'In Progress',
    statusDescription: 'Actualmente en la fase de preparación del terreno y adquisición de semillas. Pendiente reunión con la comunidad para asignar parcelas.',
  ...
  },
  {
    ...
    status: 'Planning',
    statusDescription: 'Definiendo el currículo final y buscando voluntarios para facilitar los talleres.',
  ...
  },
  {
    ...
    status: 'Completed',
    statusDescription: 'Se recolectaron más de 2 toneladas de desechos. Informe final entregado a la alcaldía.',
   ...
   {
    id: '4',
    projectName: 'Renovación del Parque Infantil "Los Girasoles"',
    location: 'Urb. La Soledad, Palo Negro',
    responsibleDepartment: 'Arquitectura',
    projectLead: 'Carlos Eduardo Vargas Peña',
    academicTutor: 'Arq. Isabel Jiménez',
    communityTutor: 'Sra. Rosaura Linares',
    contactInformation: 'c.vargas@unefa.edu.ve',
    status: 'On Hold',
    statusDescription: 'Proyecto en pausa debido a la espera de aprobación de presupuesto municipal para materiales.',
    description: 'Rehabilitación integral del parque infantil, incluyendo reparación de juegos, pintura y mejora de áreas verdes.',
    projectType: 'Infraestructura Comunitaria',
    publicObjective: 'Ofrecer un espacio seguro y recreativo para los niños de la comunidad.',
    scope: 'Diseño participativo, reparación de equipos existentes, instalación de nuevos juegos, pintura general, siembra de árboles.',
